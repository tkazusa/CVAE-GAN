...
class CVAEGAN(CondBaseModel):
    ...
    def build_encoder(self, output_dims):
        ...
        for filters in [32]:
            x = ResidualConvLayer(filters=filters)(x)
            #x = ResidualConvLayer(filters=filters)(x)
            #x = ResidualConvLayer(filters=filters)(x)
            #x = ResidualConvLayer(filters=filters)(x)
    ...
    def build_decoder(self):
        ...
        x = BasicDeconvLayer(filters=156, strides=(1, 1))(x)
        x = BasicDeconvLayer(filters=118, strides=(1, 1))(x)
        x = BasicDeconvLayer(filters=64, strides=(1, 1))(x)
        x = BasicDeconvLayer(filters=32, strides=(1, 1))(x)
